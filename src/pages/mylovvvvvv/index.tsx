...
const TimerPage = () => {
    ...
    useEffect(() => {
        const timer = setInterval(() => {
            ...
            const monthDifference = difference % (1000 * 60 * 60 * 24 * 365.25);
            const months = Math.floor(monthDifference / (1000 * 60 * 60 * 24 * 30.44));
            const days = Math.floor((monthDifference % (1000 * 60 * 60 * 24 * 30.44)) / (1000 * 60 * 60 * 24));
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-center space-x-4 text-center bg-white/10 dark:bg-black/10 p-6 rounded-lg">
                ...
                {(timePassed.years > 0 || timePassed.months > 0) && (
                    <div>
                        <div className="text-2xl font-bold">{timePassed.months}</div>
                        <div>Months</div>
                    </div>
                )}
                <div>
