...
export function Preloader() {
  ...
  return (
    <div
      id="global-preloader"
      className={`fixed inset-0 z-9999 flex items-center justify-center bg-(--bg-primary) transition-opacity duration-700 ease-in-out ${
    ...
    >
      ...
      <div className="relative flex flex-col items-center gap-4 w-64">
        ...
        <div className="flex justify-between w-full text-xs font-medium text-(--text-muted)">
          <span className="font-['Outfit'] tracking-wider uppercase">
            Loading
          </span>
